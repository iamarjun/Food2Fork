        ...
        coroutineScope.launch {
            ...
            when (val list = restApi.searchRecipe(query, PAGE)) {
                ...
                is NetworkResponse.ServerError -> {
                    ...
                    _initialLoad.postValue(NetworkState.error("Server Error"))
                }
                is NetworkResponse.NetworkError -> {
                    ...
                    _initialLoad.postValue(NetworkState.error("Network Error"))
                }
            }
        }
    }
        ...
        coroutineScope.launch {
            ...
            when (val list = restApi.searchRecipe(query, params.key.toString())) {
                ...
                is NetworkResponse.ServerError -> {
                    ...
                    _networkState.postValue(NetworkState.error("Server Error"))
                }
                is NetworkResponse.NetworkError -> {
                    // Handle Network Error
                    retry = {
